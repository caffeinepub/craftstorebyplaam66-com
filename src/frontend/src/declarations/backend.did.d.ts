...
export interface OrderedItem { 'productId' : string, 'quantity' : bigint }
...
export interface _SERVICE {
  ...
  'createOrder' : ActorMethod<
    [CustomerDetails, Array<OrderedItem>, bigint],
    string
  >,
  ...
  'getPendingOrdersForCustomer' : ActorMethod<[string], Array<Order>>,
  ...
  'seedCatalog' : ActorMethod<[], undefined>,
  'setStripeConfiguration' : ActorMethod<[StripeConfiguration], undefined>,
  'transform' : ActorMethod<[TransformationInput], TransformationOutput>,
  'updateOrderPaymentStatus' : ActorMethod<[string, PaymentStatus], undefined>,
}
