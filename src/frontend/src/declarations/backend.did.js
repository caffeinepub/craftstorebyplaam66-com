...
export const idlService = IDL.Service({
  ...
  'createOrder' : IDL.Func(
      [CustomerDetails, IDL.Vec(OrderedItem), IDL.Nat],
      [IDL.Text],
      [],
    ),
  ...
  'getPendingOrdersForCustomer' : IDL.Func(
      [IDL.Text],
      [IDL.Vec(Order)],
      ['query'],
    ),
  ...
  'updateOrderPaymentStatus' : IDL.Func([IDL.Text, PaymentStatus], [], []),
});
