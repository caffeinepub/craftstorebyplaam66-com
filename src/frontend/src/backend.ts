...
import type { CustomerDetails as _CustomerDetails, Order as _Order, OrderedItem as _OrderedItem, PaymentStatus as _PaymentStatus, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: CustomerDetails, arg1: Array<OrderedItem>, arg2: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getPendingOrdersForCustomer(arg0: string): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingOrdersForCustomer(arg0);
    ...
    async seedCatalog(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedCatalog();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateOrderPaymentStatus(arg0: string, arg1: PaymentStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateOrderPaymentStatus(arg0, to_candid_PaymentStatus_n15(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
